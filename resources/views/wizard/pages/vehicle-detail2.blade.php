    ...
    <div style = "" class = "section_container">
        ...
        <div class = "block1">
            ...
            <div class = "cal_payment_block">
                ...
                <div class ="payment_line_item">
                    <div class = "payment_line_label">Incentive/Rebates</div>
                ...
                <div class ="payment_line_item">
                    <div class = "payment_line_label">Fees</div>
                    <div class = "payment_line_value fees_value">${{$offerlogix['financing']['fees']}}</div>
                </div>

                <div class ="payment_line_item">
                    <div class = "payment_line_label">Taxes</div>
        ...
        <div class = "about_block">
            ...
            <div style = "margin-bottom: 20px!important;" class = "cal_block_mobile" >
                <div data-type="key_features" class = "about_label ">Key Features</div>
                <div data-type="extra_features" class = "about_label">Extra Features</div>
                <div data-type="info" class = "about_label  about_selected">Information</div>
            </div>
            <div style = "display:none" class = "key_features_block">
                <div class ="row">
    ...
    <script>
        ...
        if("{{$show_financing}}" == "true") {
            ...
            if(offerlogix_settings.tradein_options == 'false'){
                var tradein_search = tradein_search_default;
            }else{
                var tradein_search = offerlogix_settings.tradein_options;
        ...
        function updatePayment(){
            ...
            if(selected == 'finance'){
               ...
               // if(option['downPayment'] != downpayment){
                    ...
                    $.each(option.fee_detail, function (i, item) {
            ...
            $('.fees_value').html('$'+parseInt(fees).toLocaleString("en-US"));
...
// When the user clicks on <span> (x), close the modal
            ...
            $(document).on('click', '.about_label', function() {
                ...
                if(type == 'extra_features')$('.extra_key_features_block').show();
