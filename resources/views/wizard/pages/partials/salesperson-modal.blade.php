<template id="contact_salesperson">
    ...
    <swal-html>
        ...
        <div class="modal-salesperson-header">
            <img class="modal-salesperson-image" src="{{$api_endpoints['image']}}/uploads/media/profile_images/cropped/{{ $salesperson->photo }}" width="75px" />
            <div class="modal-salesperson-grid">
                <span class="modal-salesperson-header-text modal-salesperson-left">{{$salesperson->first}} {{$salesperson->last}}</span>
        ...
        <div class="modal-salesperson-form">
            ...
            <div style = "margin-bottom: 20px; display: flex; justify-content: space-between">
                <div>
                    ...
                    <input style="max-width: 200px;" type="text" id="modal-salesperson-fname" name="modal-salesperson-fname"  class="form-control" value="{{ old('fname', $deal->fname) }}">

                </div>
                <div>
                    <label style="font-size: 15px">Last Name</label>
                    <input style="max-width:200px;" type="text" id="modal-salesperson-lname" name="modal-salesperson-lname"  class="form-control" value="{{ old('lname', $deal->lname) }}">

                </div>
            </div>

            <label style="font-size: 15px">Phone Number</label>
            <input style="max-width: 200px;" type="text" id="modal-salesperson-phone" name="modal-salesperson-phone"  class="form-control" value="{{ old('lname', $deal->phone) }}">
            ...
            <div id="modal-salesperson-optin-block" style = "margin-top:20px" class="text-opt-in">
                <div class="checkbox">
                    ...
                    <label for="text_opt_in">
                        ...
                        <span class="cb-text" style="font-size:15px;margin-left: 35px!important;">I agree to receiving Text Messages from {{ $dealer->dealer_name }}.  You will receive a text message from phone number <br> {{$nicePhone}} </span>
                    </label>
